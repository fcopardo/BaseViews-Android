 ...
 * an instance of {@link android.support.v4.view.AsyncLayoutInflater} on the UI thread and call
 * {@link #inflate(int, ViewGroup, android.support.v4.view.AsyncLayoutInflater.OnInflateFinishedListener)}. The
 * {@link android.support.v4.view.AsyncLayoutInflater.OnInflateFinishedListener} will be invoked on the UI thread
 ...
 * asynchronously for whatever reason, {@link android.support.v4.view.AsyncLayoutInflater} will
 ...
 * {@link ViewGroup#addView(View)} in the {@link android.support.v4.view.AsyncLayoutInflater.OnInflateFinishedListener}
